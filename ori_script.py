...
# NOTE: script taken from: https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/API
...
if __name__ == '__main__':
    ...
    init_images = [
        encode_file_to_base64("/home/boss/Downloads/blank.jpeg"),
                ...
                "args": [
                    {
                        ...
                        "guidance_start": 0,
                        "image": {
                            "image": encode_file_to_base64("/home/boss/Downloads/image.png"),
                            "mask": None  # base64, None when not need
                        },
                        "input_mode": "simple",
                        "is_ui": True,
